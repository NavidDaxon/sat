...
/**
 * Upgrade library code for the satexam question type.
 *
 * @package    qtype
 * @subpackage satexam
...
/**
 * Class for converting attempt data for satexam questions when upgrading
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_satexam_qe2_attempt_updater extends question_qtype_attempt_updater {
    protected $order;

    public function is_blank_answer($state) {
        // Blank satexam answers are not empty strings, they rather end in a colon.
