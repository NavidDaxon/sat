...
/**
 * SAT Exam question definition classes.
 *
 * @package    qtype
 * @subpackage satexam
...
/**
 * Base class for SAT Exam questions. The parts that are common to
 * single select and multiple select.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_satexam_base extends question_graded_automatically {
    ...
    public function apply_attempt_state(question_attempt_step $step) {
        ...
        foreach ($this->order as $ansid) {
            ...
            $a = new stdClass();
            $a->id = 0;
            $a->answer = html_writer::span(get_string('deletedchoice', 'qtype_satexam'),
                    'notifyproblem');
    ...
    public function validate_can_regrade_with_other_version(question_definition $otherversion): ?string {
        ...
        if (count($this->answers) != count($otherversion->answers)) {
            return get_string('regradeissuenumchoiceschanged', 'qtype_satexam');
        }
...
/**
 * Represents a SAT Exam question where only one choice should be selected.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_satexam_single_question extends qtype_satexam_base {
    public function get_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_satexam', 'single');
    }
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseselectananswer', 'qtype_satexam');
    }
...
/**
 * Represents a SAT Exam question where SAT Exams can be selected.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_satexam_multi_question extends qtype_satexam_base {
    public function get_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_satexam', 'multi');
    }
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseselectatleastoneanswer', 'qtype_satexam');
    }
