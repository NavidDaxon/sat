...
/**
 * Admin settings class for the satexam question type method.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_satexam_admin_setting_answernumbering extends admin_setting_configselect {
    ...
    public function load_choices() {
        ...
        require_once($CFG->dirroot . '/question/type/satexam/questiontype.php');
        $this->choices = qtype_satexam::get_numbering_styles();
