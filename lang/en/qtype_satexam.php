...
/**
 * Strings for component 'qtype_satexam', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
 * @subpackage satexam
...
$string['pluginname'] = 'SAT Exam';
$string['pluginname_help'] = 'In response to a question (that may include an image) the respondent chooses from multiple answers. A SAT Exam question may have one or multiple correct answers.';
$string['pluginname_link'] = 'question/type/satexam';
$string['pluginnameadding'] = 'Adding a SAT Exam question';
$string['pluginnameediting'] = 'Editing a SAT Exam question';
$string['pluginnamesummary'] = 'Allows the selection of a single or multiple responses from a pre-defined list.';
$string['privacy:metadata'] = 'SAT Exam question type plugin allows question authors to set default options as user preferences.';
...
$string['showstandardinstruction_desc'] = 'Whether to show the instructions "Select one:" or "Select one or more:" before SAT Exam answers.';
$string['showstandardinstruction_help'] = 'Whether to show the instructions \'Select one:\' or \'Select one or more:\' before SAT Exam answers. Alternatively, you can include instructions in the question text.';
